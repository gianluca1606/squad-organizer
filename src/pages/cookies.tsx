            ...
            <Card className="relative mt-4 block w-full  p-0 sm:w-full md:p-6 xl:w-10/12 2xl:w-8/12">
                ...
                <CardContent>
                    ...
                    <p className="mb-8 overflow-auto text-center font-light  sm:text-xl lg:mb-16">
                        ...
                        option within the app&apos;s settings menu. Please note that if you disable certain cookies, it
                        may affect your app experience and limit the availability of certain features.
                    </p>
                    <p className="mb-8 overflow-auto text-center font-light  sm:text-xl lg:mb-16">
