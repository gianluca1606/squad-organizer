...
const Transactions: FC = () => {
  return (
    <div className="flex justify-center ">
      <div className="mt-4 w-full rounded-lg  border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:w-8/12 sm:p-6">
        {/* Card header */}
            ...
            <div className="flex items-center">
              ...
              <div
                ...
                style={{
                  ...
                  margin: 0,
                  transform: "translate3d(119.5px, 6237px, 0px)",
                }}
                ...
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                  ...
                  <tbody className="bg-white dark:bg-gray-800">
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap p-4">
                        <span className="mr-2 rounded-md border border-red-100 bg-red-100 px-2.5 py-0.5 text-xs font-medium text-red-800 dark:border-red-400 dark:bg-gray-700 dark:text-red-400">
                          Cancelled
                        </span>
                      </td>
                    </tr>
                    <tr className="bg-gray-50 dark:bg-gray-700">
                      ...
                      <td className="whitespace-nowrap p-4">
                        <span className="mr-2 rounded-md border border-purple-100 bg-purple-100 px-2.5 py-0.5 text-xs font-medium text-purple-800 dark:border-purple-500 dark:bg-gray-700 dark:text-purple-400">
                          In progress
                        </span>
                      </td>
                    </tr>
                    ...
                    <tr className="bg-gray-50 dark:bg-gray-700">
                      ...
                      <td className="whitespace-nowrap p-4">
                        <span className="mr-2 rounded-md border border-orange-100 bg-orange-100 px-2.5 py-0.5 text-xs font-medium text-orange-800 dark:border-orange-300 dark:bg-gray-700 dark:text-orange-300">
                          In review
                        </span>
                      </td>
                    </tr>
