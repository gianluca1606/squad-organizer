...
import { CreatePunishmentDialog } from "~/components/forms/CreatePunishmentDialog";
  ...
  return (
    <div className=" flex w-full flex-col items-center">
      <Card className="relative mt-4 block w-full  p-6  sm:w-10/12 md:w-full lg:w-8/12 2xl:w-6/12">
        ...
        <CardContent>
          <div className="absolute  right-0 top-0 ">
            ...
            <CreateTeamForm edit={true} data={teamData.data}></CreateTeamForm>
      ...
      <Card className="relative mt-4 block w-full  p-6  sm:w-10/12 md:w-full lg:w-8/12 2xl:w-6/12">
        ...
        <CardContent>
          <div className="absolute  right-0 top-0 ">
            <CreatePunishmentDialog></CreatePunishmentDialog>
          </div>
